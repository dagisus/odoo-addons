...
class doctor_attentions(osv.osv):
    ...
    _columns = {
        ...
        'professional_image': fields.related('professional_id', 'image_small', type="binary", relation='doctor.professional', readonly=True, store=False, string='Professional Image'),
    ...
    def onchange_professional(self, cr, uid, ids, professional_id, context=None):
        ...
        professional_img = professional_data.user_id.partner_id.image
