...
class doctor_schedule(osv.osv):
    ...
    def _date_to_dateuser(self, cr, uid, ids, date_begin):
        user = self.browse(cr, uid, ids).professional_id.user_id
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        for record in self.browse(cr, uid, ids, context=context):
            display_name = record.professional_id.user_id.name + ' (' + \
                           self._date_to_dateuser(cr, uid, record.id, record.date_begin) + ' - ' + \
                           self._date_end_to_dateuser( cr, uid, record.id, record.date_end) + ')'
